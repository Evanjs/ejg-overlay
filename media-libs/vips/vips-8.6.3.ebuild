...
inherit ltprune python-single-r1 versionator
...
SRC_URI="https://github.com/jcupitt/libvips/archive/$(get_version_component_range 1-2).tar.gz"
HOMEPAGE="http://vips.sourceforge.net"

LICENSE="LGPL-2.1"
SLOT="0/42"
KEYWORDS="~amd64 ~x86"
IUSE="debug exif fits fftw gsf imagemagick jpeg lcms openexr +orc pdf png python static-libs svg tiff webp"
